...
setup(name='desietc',
      version='0.1.18.dev347',  # MAKE SURE THIS MATCHES desietc/_version.py! There are also ways to automate this.
      ...
      zip_safe=False,
      entry_points = {'console_scripts': ['etcreplay=desietc.scripts.replay:main',
