...
class Accumulator(object):
    ...
    def update(self, src, mjd_src, mjd_now):
        ...
        self.aux_mean = {}
        for aux_name in ('transp_obs', 'transp_zenith', 'ffrac_psf', 'ffrac_elg', 'ffrac_bgs', 'thru_psf', 'thru_elg', 'thru_bgs'):
    ...
    def get_efftime(self, realtime, signal, background, scale=1.3618014901561835):
